...
class OptionsView(AbstractView):
    ...
    def __init__(self) -> None:
        ...
        self.__BTN_POS = [
            (self._views_size[0]/3, self._views_size[0]/2 - 250),
            (self._views_size[0]/3, self._views_size[0]/2 - 175),
            (self._views_size[0]/3, self._views_size[0]/2 - 100),
            (self._views_size[0]*2/3, self._views_size[0]/2 - 250),
            (self._views_size[0]*2/3, self._views_size[0]/2 - 100)
        ]
        ...
        self.__TEXT_POS = [
            ...
            (self._views_size[0]/3, self._views_size[0]/2 - 300)
        ]
